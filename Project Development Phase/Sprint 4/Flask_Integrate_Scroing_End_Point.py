...
def index():
    if request.method == 'POST':
        try:
            ...
            response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/2c6a0497-ed41-4976-857e-a9ce6ef2fa18/predictions?version=2022-11-18', json=payload_scoring,
            ...
            return render_template('output.html', 
                                    prediction = output, car_name =request.form.get('company')+" "+car_name,
                                    car_year=car_year )
        except Exception as e:
            print(e)
